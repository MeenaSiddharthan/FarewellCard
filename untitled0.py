...
#bgcolor takes either color string or (r,g,b) values
window.bgcolor("#fffdd0") 
window.title("Farewell Card") 
...
text.write("We'll miss you Reine!", font=("Apple Chancery", 30, "bold"), align="center") 
